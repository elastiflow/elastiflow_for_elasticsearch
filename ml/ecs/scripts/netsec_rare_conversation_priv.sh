...
echo ""; echo "Installing anomaly_detector elastiflow_ecs_netsec_rare_conversation_priv ..."
curl -XPUT -u ${USERNAME}:${PASSWORD} -k ${ES_HOST}/_ml/anomaly_detectors/elastiflow_ecs_netsec_rare_conversation_priv?pretty -H "Content-Type: application/json" -d "${DETECTOR}"
echo ""; echo "Installing datafeed elastiflow_ecs_netsec_rare_conversation_priv ..."
curl -XPUT -u ${USERNAME}:${PASSWORD} -k ${ES_HOST}/_ml/datafeeds/datafeed-elastiflow_ecs_netsec_rare_conversation_priv?pretty -H "Content-Type: application/json" -d "${DATAFEED}"
