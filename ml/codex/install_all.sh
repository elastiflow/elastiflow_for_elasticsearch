...
./avail_dhcp_relay_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_dhcp_resp_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_dhcp_resp_ratio_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_dns_resp_ratio_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_dns_resp_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_ntp_resp_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_ntp_resp_ratio_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./avail_ntp_sym_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
