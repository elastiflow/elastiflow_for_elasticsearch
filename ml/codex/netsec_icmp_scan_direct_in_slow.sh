...
echo ""; echo "Installing anomaly_detector elastiflow_codex_netsec_icmp_scan_direct_in_slow ..."
curl -XPUT -u ${USERNAME}:${PASSWORD} -k ${ES_HOST}/_ml/anomaly_detectors/elastiflow_codex_netsec_icmp_scan_direct_in_slow?pretty -H "Content-Type: application/json" -d "${DETECTOR}"
echo ""; echo "Installing datafeed elastiflow_codex_netsec_icmp_scan_direct_in_slow ..."
curl -XPUT -u ${USERNAME}:${PASSWORD} -k ${ES_HOST}/_ml/datafeeds/datafeed-elastiflow_codex_netsec_icmp_scan_direct_in_slow?pretty -H "Content-Type: application/json" -d "${DATAFEED}"
