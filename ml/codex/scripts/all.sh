...
./availability/avail_dhcp_relay_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_dhcp_resp_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_dhcp_resp_ratio_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_dns_resp_ratio_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_dns_resp_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_ntp_resp_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_ntp_resp_ratio_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_ntp_sym_low.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_tcp_sess_fails_edge.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_tcp_sess_fails_in.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_tcp_sess_fails_out.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
./availability/avail_tcp_sess_fails_priv.sh -h ${ES_HOST} -u ${USERNAME} -p ${PASSWORD}
